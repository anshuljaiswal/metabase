...
(deftest currency-test
  (are [s n c] (= s (numbers/format-number n {:number-style "currency" :currency c :locale "en"}))
       ...
       "$7.25"           7.245       "USD"
       "$7.25"           7.249       "USD"
       "$7.26"           7.255       "USD" ;; TODO Java side needs half-expand here too
       "$724.90"         724.90      "USD"
  ...
  (testing "by code"
    (are [s n c] (= s (numbers/format-number n {:number-style "currency" :currency c :currency-style "code"}))
         ;; NB In CLJS the space after the currency symbol is a UTF-8 $c2a0, non-breaking space.
         "USD 1.23"           1.23        "USD"
         "-USD 1.23"          -1.23       "USD"
         "USD 0.00"           0           "USD"
         "USD 0.00"           0.001       "USD"
         ...
         "USD 7.25"           7.245       "USD"
         "USD 7.25"           7.249       "USD"
         "USD 7.26"           7.255       "USD" ;; TODO Java side needs half-expand here too
...
;; TODO(braden) Sanity check the removal of the currency_in_header option - no testing here for it.
;; It's only used in the FormattingWidget's `Currency` column type, so the special handling could be moved there.
